...
Each act of the demo corresponds to one test here. These exercise the
deterministic substrate the agent-on-top relies on: same input -> same
output, every time. No subprocess, no LLM.
"""
